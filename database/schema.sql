...
COMMENT ON COLUMN connection_feedbacks.feedback_type IS 'Тип отметки: HELPED_ME (мне помогли), I_HELPED (я помог), PROJECT_TOGETHER (совместный проект), EVENT_TOGETHER (совместный ивент)';
